...
public class CascadingTupleComparator extends TupleComparatorBase<Tuple> {

	private static final long serialVersionUID = 1L;

	public CascadingTupleComparator(int[] keyPositions, TypeComparator<?>[] comparators, TypeSerializer<?>[] serializers) {
		super(keyPositions, comparators, serializers);
	}

	private CascadingTupleComparator(CascadingTupleComparator toClone) {
		super(toClone);
	}
	...
	public TypeComparator<Tuple> duplicate() {
		return new CascadingTupleComparator(this);
	}
